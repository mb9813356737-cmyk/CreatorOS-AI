...
export interface AnimatedSearchProps extends React.InputHTMLAttributes<HTMLInputElement> {
    ...
    return (
      <div className={cn("relative flex items-center justify-center", containerClassName)}>
        <div id="poda" className="relative flex items-center justify-center group">
          {/* Neon Conic Gradient Glow Borders */}
          <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[314px] rounded-xl blur-[3px] 
                          ...
                          before:bg-[conic-gradient(#000,#402fb5_5%,#000_38%,#000_50%,#22D3EE_60%,#000_87%)] before:transition-all before:duration-2000
          ...
          <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[312px] rounded-xl blur-[3px] 
                          ...
                          before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6366F1,rgba(0,0,0,0)_60%)] before:transition-all before:duration-2000
          ...
          <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[307px] rounded-lg blur-[2px] 
                          ...
                          before:bg-[conic-gradient(rgba(0,0,0,0)_0%,#a099d8,rgba(0,0,0,0)_8%,rgba(0,0,0,0)_50%,#A78BFA,rgba(0,0,0,0)_58%)] before:brightness-140
          ...
          <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[303px] rounded-xl blur-[0.5px] 
                          ...
                          before:bg-[conic-gradient(#1c191c,#402fb5_5%,#1c191c_14%,#1c191c_50%,#22D3EE_60%,#1c191c_64%)] before:brightness-130
          ...
          <div id="main" className="relative group">
            <input
              ...
              className={cn(
                "bg-[#010201] border-none w-[301px] h-[56px] rounded-lg text-white px-[59px] text-lg focus:outline-none placeholder-zinc-300 transition-colors",
                className
              )}
              {...props}
            />
            {/* Glowing spot overlay */}
            <div id="pink-mask" className="pointer-events-none w-[30px] h-[20px] absolute bg-[#22D3EE] top-[10px] left-[5px] blur-2xl opacity-80 transition-all duration-2000 group-hover:opacity-0"></div>
            {/* Animated rotating gear backdrop behind filter icon */}
